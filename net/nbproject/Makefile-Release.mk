...
${OBJECTDIR}/src/epoll_event.o: src/epoll_event.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/epoll_event.o src/epoll_event.cc
...
${OBJECTDIR}/src/socket_buffer.o: src/socket_buffer.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/socket_buffer.o src/socket_buffer.cc

${OBJECTDIR}/src/tcp_accept.o: src/tcp_accept.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tcp_accept.o src/tcp_accept.cc

${OBJECTDIR}/src/tcp_socket.o: src/tcp_socket.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tcp_socket.o src/tcp_socket.cc
